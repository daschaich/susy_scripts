...
# ------------------------------------------------------------------
# Plot histogram of Polyakov loop eigenvalues from output files 'PLeig'
...
# Parse arguments: SU(12) and SU(16) ensembles,
# following by the title for the plot
if len(sys.argv) < 4:
  print "Usage:", str(sys.argv[0]), "<SU(12) dir> <SU(16) dir>",
